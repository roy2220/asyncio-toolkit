...
"\n"
"    - Callbacks registered with add_immediate_done_callback() are always called\n"
"      immediately.\n"
"\n"
...
PyDoc_STRVAR(_asyncio_Future_add_immediate_done_callback__doc__,
"add_immediate_done_callback($self, fn, /)\n"
"--\n"
"\n"
"Add a callback to be run immediately when the future becomes done.\n"
"\n"
"The callback is called with a single argument - the future object. If\n"
"the future is already done when this is called, the callback is\n"
"scheduled immediately.");

#define _ASYNCIO_FUTURE_ADD_IMMEDIATE_DONE_CALLBACK_METHODDEF    \
    {"add_immediate_done_callback", (PyCFunction)_asyncio_Future_add_immediate_done_callback, METH_O, _asyncio_Future_add_immediate_done_callback__doc__},
...
PyDoc_STRVAR(_asyncio_Future_remove_immediate_done_callback__doc__,
"remove_immediate_done_callback($self, fn, /)\n"
"--\n"
"\n"
"Remove all instances of a callback from the \"call immediately when done\" list.\n"
"\n"
"Returns the number of callbacks removed.");

#define _ASYNCIO_FUTURE_REMOVE_IMMEDIATE_DONE_CALLBACK_METHODDEF    \
    {"remove_immediate_done_callback", (PyCFunction)_asyncio_Future_remove_immediate_done_callback, METH_O, _asyncio_Future_remove_immediate_done_callback__doc__},
...
PyDoc_STRVAR(_asyncio_Future__schedule_immediate_callbacks__doc__,
"_schedule_immediate_callbacks($self, /)\n"
"--\n"
"\n");

#define _ASYNCIO_FUTURE__SCHEDULE_IMMEDIATE_CALLBACKS_METHODDEF    \
    {"_schedule_immediate_callbacks", (PyCFunction)_asyncio_Future__schedule_immediate_callbacks, METH_NOARGS, _asyncio_Future__schedule_immediate_callbacks__doc__},

static PyObject *
_asyncio_Future__schedule_immediate_callbacks_impl(FutureObj *self);

static PyObject *
_asyncio_Future__schedule_immediate_callbacks(FutureObj *self, PyObject *Py_UNUSED(ignored))
{
    return _asyncio_Future__schedule_immediate_callbacks_impl(self);
}
